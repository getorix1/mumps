...
//=================================================================================
        svPtr->LineNumber=8; //  set M=$zgetenv("in_docs")
//=================================================================================
...
//--------------
        ...
        strxcat((char *) catx,(char *) "in_docs");
...
//=================================================================================
        svPtr->LineNumber=10; //  set M=1000000
//=================================================================================
...
//=================================================================================
        svPtr->LineNumber=11; //  open 1:"../titles.list,new"
//=================================================================================
...
//=================================================================================
        svPtr->LineNumber=16; //  for  do  if D>M quit
//=================================================================================
...
//=================================================================================
            svPtr->LineNumber=17; //  . set off=$ztell read line if '$test break
//=================================================================================
...
//=================================================================================
            svPtr->LineNumber=18; //  . set line=$translate(line,"0123456789""`~!@#$%^&*()_+=?>.<,:;'{[}]")
//=================================================================================
...
//--------------
            ...
            strxcat((char *) catx,(char *) "0123456789\"`~!@#$%^&*()_+=?>.<,:;\'{[}]");
            strxcat((char *) catx,"\xcf");
            strmove((UNS) &svPtr->v1d[1], (UNS) &gtmp[1]);
            fcn(svPtr);
            strmove((UNS) tmp2, (UNS) &svPtr->bd[1]);
            sym_(SYMSTORE, (UNS) "line", (UNS) tmp2, svPtr); // Store result s274

//=================================================================================
            svPtr->LineNumber=19; //  . set line=$translate(line,"-"," ")
//=================================================================================
...
//=================================================================================
            svPtr->LineNumber=20; //  . if $extract(line,1,2)="TI" do  quit
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=22; //  .. use 1 write D," ",$extract(line,7,200),! use 5
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=23; //  .. write off," ",D
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=24; //  .. set ^map(D)=off
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=25; //  .. set line=$zlower($e(line,7,2048))
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=26; //  .. set line=$zblanks(line)
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=27; //  .. for i=1:1 do
//=================================================================================
...
//	m2525
                ...
                if (strchr((char *) for3_incr, '.')) { // inc/dec is float
                    for3D = atof(for3_incr); // inc/dec value
                    for3F = for3D < 0.0 ? 1 : 0; // incr or decr?
                    }
                else { // inc/dec is integer
                    for3 = atol(for3_incr); // inc/dec value
                    for3F = for3 < 0 ? 1 : 0; // incr or decr?
                    }
...
//=================================================================================
                    svPtr->LineNumber=28; //  ... s w=$p(line," ",i) if $l(w)=0 break
//=================================================================================
...
//=================================================================================
            svPtr->LineNumber=30; //  . if $extract(line,1,2)="MH" quit
//=================================================================================
...
//=================================================================================
            svPtr->LineNumber=31; //  . if $extract(line,1,13)="STAT  MEDLINE" write:D'=0 ! quit
//=================================================================================
...
//--------------
            ...
            if (numcomp2((UNS) tmp2 )) { // Test if true
                ...
                if (sym_(SYMGET, (UNS) "D", (UNS) tmp3, svPtr) == NULL) // get value
                    VariableNotFound1(svPtr->LineNumber, (UNS) "D"); // not found
                if (strcmp((const char *) tmp3, (const char *) "0") != 0)
                    strmove((UNS) tmp4, (UNS) "1");
                else strmove((UNS) tmp4, (UNS) "0");
                if (atoi( CSTR tmp4)) { // m859 postconditional
...
//=================================================================================
            svPtr->LineNumber=32; //  . if $extract(line,1,2)'="AB" quit
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=34; //  .. set line=$zlower($e(line,7,2048))
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=35; //  .. set line=$zblanks(line)
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=36; //  .. for i=1:1 do
//=================================================================================
...
//	m2525
                ...
                if (strchr((char *) for6_incr, '.')) { // inc/dec is float
                    for6D = atof(for6_incr); // inc/dec value
                    for6F = for6D < 0.0 ? 1 : 0; // incr or decr?
                    }
                else { // inc/dec is integer
                    for6 = atol(for6_incr); // inc/dec value
                    for6F = for6 < 0 ? 1 : 0; // incr or decr?
                    }
...
//=================================================================================
                    svPtr->LineNumber=37; //  ... set w=$p(line," ",i) if $l(w)=0 break
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=39; //  .. read line if '$test break
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=40; //  .. set line=$translate(line,"0123456789""`~!@#$%^&*()_+=?>.<,:;'{[}]")
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=41; //  .. if line="" write " ","eoleol" break
//=================================================================================
...
//=================================================================================
                svPtr->LineNumber=42; //  .. if $find(line,"ABSTRACT") set line=$piece(line,"ABSTRACT",1)
//=================================================================================
