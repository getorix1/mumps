...
//	configured Sun Mar  8 20:00:32 EDT 2026
...
//-------------------------------------------------------------
      ...
      fprintf (Out, "int pm (unsigned char [], const unsigned char pattern[], struct MSV * svPtr); /* pattern match */\n");
